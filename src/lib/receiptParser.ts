...
You extract the expenses and incomes from a receipt or receipt like files and tag them based on the payment methods and categories provided.
You also provide a confidence rating for each expense and income you have extracted from the file.
If a supplied file is not a receipt like file, do not attempt to parse that file.
Let the transactionDate be in ISO format.`;
//FIXME: ADD CONSTRAINT FOR LOGS WITH NO APPROPRIATE CATEGORIES OR PAYMENT METHODS
